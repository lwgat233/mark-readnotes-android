...
- 当前构件：`apk/mark-readnotes-debug-20260922-r7.apk`（页内标记 `0.1.0+r12`，一个标签＝一个文件）
  sha256 `dde4385633da6cf507017a1ede35db077605c77d9933ee58a0036f65b6eb28fd`
  历史：`…-r6.apk`（随笔独立目录 + 文件夹）、`…-r5.apk`（渲染层重写）、`…-r4.apk`（重构）、`…-r3.apk`（导出）、`…-r2.apk`（公式/图片）、`…-20260922.apk`（第 1 轮闭环）
...
| 第 6 轮怎么验的（随笔目录 / 文件夹 / 整理旧布局） | `docs/验收清单-第6轮.md`、`docs/新需求规格-随笔独立目录.md` |
| 第 7 轮怎么验的（一个标签一个文件：搬家 + 同名合并） | `docs/验收清单-第7轮.md` |
