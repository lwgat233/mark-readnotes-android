...
window.MRN_REGISTRY = {
  ...
  "features": [
    ...
    { "id": "render.md",      "board": "render", "name": "markdown 渲染（标题/列表/引用/代码）", "carrier": "预览层", "entry": "白板 预览", "testId": "#btn-preview", "status": "done", "test": "boards/render.sh#R1" },
    { "id": "render.table",   "board": "render", "name": "表格", "carrier": "预览层", "entry": "白板 预览", "testId": "#btn-preview", "status": "done", "test": "boards/render.sh#R1" },
    { "id": "render.tasks",   "board": "render", "name": "任务清单（勾选框）", "carrier": "预览层", "entry": "白板 预览", "testId": "#btn-preview", "status": "done", "test": "boards/render.sh#R2" },
    { "id": "render.nested",  "board": "render", "name": "嵌套列表", "carrier": "预览层", "entry": "白板 预览", "testId": "#btn-preview", "status": "done", "test": "boards/render.sh#R3" },
    { "id": "render.tex",     "board": "render", "name": "数学公式（四种写法，内置 KaTeX）", "carrier": "预览层", "entry": "白板 预览", "testId": "#btn-preview", "status": "done", "test": "boards/render.sh#R4" },
    { "id": "render.img",     "board": "render", "name": "图片（markdown 与原始 HTML 两种写法）", "carrier": "预览层", "entry": "白板 预览", "testId": "#btn-preview", "status": "done", "test": "boards/render.sh#R7" },
    { "id": "render.sanitize","board": "render", "name": "基本 HTML 白名单消毒", "carrier": "预览层", "entry": "白板 预览", "testId": "#btn-preview", "status": "done", "test": "boards/render.sh#R5" },
